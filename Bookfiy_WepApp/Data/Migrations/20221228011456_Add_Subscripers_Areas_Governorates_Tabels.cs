...
{
    public partial class Add_Subscripers_Areas_Governorates_Tabels : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NantionalId = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    ...
                    IsBlackedListed = table.Column<bool>(type: "bit", nullable: false),
                    CreatedById = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    IsDelete = table.Column<bool>(type: "bit", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastUpdateOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Subscripers_AspNetUsers_LastUpdateById",
                        column: x => x.LastUpdateById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subscripers_LastUpdateById",
                table: "Subscripers",
                column: "LastUpdateById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subscripers_NantionalId",
                table: "Subscripers",
                column: "NantionalId",
                unique: true);
